...
# Read Data ----
# + ------------------------------------------------------------------- +
setwd("D:/Personal Docs/2021-BibleStudies/")
...
pos_name <- TknsUnst_pos_max %>% filter(grepl('name', Pos_Long))
pos_nFem <- TknsUnst_pos_max %>% filter(grepl('name fem*', Pos_Long))
pos_nLoc <- TknsUnst_pos_max %>% filter(grepl('name loc*', Pos_Long))
pos_nMas <- TknsUnst_pos_max %>% filter(grepl('name mas*', Pos_Long))
pos_nPer <- TknsUnst_pos_max %>% filter(grepl('name per*', Pos_Long))
pos_noun <- TknsUnst_pos_max %>% filter(grepl('noun', Pos_Long))

sort(unique(pos_name$Text))
sort(unique(pos_nFem$Text))
sort(unique(pos_nLoc$Text))
sort(unique(pos_nMas$Text))
sort(unique(pos_nPer$Text))
sort(unique(pos_noun$Text))
